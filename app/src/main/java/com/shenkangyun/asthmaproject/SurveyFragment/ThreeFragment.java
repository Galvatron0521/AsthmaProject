...
public class ThreeFragment extends Fragment {
    ...
    private String title = "3.总的来说,在过去一周里,你的活动因哮喘收到何种程度的限制?";
    private String A = "0.无任何限制";
    private String B = "1.很轻微的收到限制";
    private String C = "2.轻微受限制";
    private String D = "3.中等度受限制";
    private String E = "4.很受限制";
    private String F = "5.极度受限制";
    private String G = "6.完全受限制";
